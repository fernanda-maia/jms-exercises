...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4020823270696061931L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"io.github.fernanda.maia.kafka.avro\",\"fields\":[{\"name\":\"customer\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static io.github.fernanda.maia.kafka.avro.Order.Builder newBuilder() {
    return new io.github.fernanda.maia.kafka.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.github.fernanda.maia.kafka.avro.Order.Builder newBuilder(io.github.fernanda.maia.kafka.avro.Order.Builder other) {
    if (other == null) {
      return new io.github.fernanda.maia.kafka.avro.Order.Builder();
    } else {
      return new io.github.fernanda.maia.kafka.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static io.github.fernanda.maia.kafka.avro.Order.Builder newBuilder(io.github.fernanda.maia.kafka.avro.Order other) {
    if (other == null) {
      return new io.github.fernanda.maia.kafka.avro.Order.Builder();
    } else {
      return new io.github.fernanda.maia.kafka.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.github.fernanda.maia.kafka.avro.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.github.fernanda.maia.kafka.avro.Order other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customer)) {
        this.customer = data().deepCopy(fields()[0].schema(), other.customer);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder setCustomer(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder clearCustomer() {
      customer = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.fernanda.maia.kafka.avro.Order.Builder clearQuantity() {
